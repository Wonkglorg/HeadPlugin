...
public class AdvancementBuilder {
    ...
    public AdvancementBuilder setValuesFromConfig() {
        ...
        icon = createIcon(Heads.manager().getConfigManager().getConfig(YML.HEAD_DATA.getFileName()), config.getString(path + ".icon"));
    ...
    public AdvancementBuilder setIcon(String icon) {
        this.icon = createIcon(Heads.manager().getConfigManager().getConfig(YML.HEAD_DATA.getFileName()), icon);
        return this;
    }
